...
import {
  changeShowModal,
  changeExitModalButton,
  changeTheme,
} from "../store/slice/actions.slice";
import "./styles.css";
  ...
  return (
    <div className={``}>
      <div
        ...
        } h-[80px] flex justify-center opacity-0 invisible absolute min-[600px]:w-screen min-[600px]:opacity-100 min-[600px]:fixed min-[600px]:visible z-50  pb-[25px] px-[50px] min-[990px]:px-[100px]`}
      >
        <div className="self-end ">
          <button onClick={changeThemeOffOn}>
            {theme ? (
              <i className="bx bxs-sun text-[30px]"></i>
            ) : (
              <i className="bx bx-moon text-[30px]"></i>
            )}
          </button>
        </div>
      ...
      <Link className="w-[30px] aspect-square"><img src="/images/skills/github.png" alt="" className="w-" /></Link>
        ...
        <div className=" h-full  max-w-[1200px] w-[100%] flex gap-6 min-[1000px]:text-[20px] min-[1000px]:gap-16 items-end justify-end min-[800px]:text-[20px] scroll-smooth">
          <div className="h-full w-full flex items-end pl-10 gap-3">
            <Link
              target="_blank"
              to={"https://github.com/VazquezRoo"}
            ...
            <Link
              target="_blank"
              to={"https://www.linkedin.com/in/cristian-vazquez-roo/"}
              className="w-[30px] aspect-square"
            >
              <img
            ...
            <Link target="_blank" to="https://wa.me/526531007177">
              <i className="bx bxl-whatsapp text-green-500 text-[25px]"></i>
            </Link>
          </div>

          <a href="#home" className="hover:text-purple-600 scroll-smooth">
            <p> Inicio</p>
          </a>
          <a href="#skills" className="hover:text-purple-600 scroll-smooth">
            <p> Conoceme</p>
          </a>
          <a href="#projects" className="hover:text-purple-600 scroll-smooth">
            <p> Proyectos</p>
          </a>
          <a href="#contact" className="hover:text-purple-600 scroll-smooth">
            <p> Contacto</p>
          </a>
        </div>
      </div>
      ...
      <div
        className=" justify-items-center right-2  mt-2 fixed top-0 flex  rounded-full min-[600px]:invisible min-[600px]:opacity-0 min-[600px]:absolute w-full justify-between pl-6 "
        bbbb
      >
        <div>
        ...
        <button
          ...
          className={`grid z-50 sticky ${
            theme ? "text-white" : "text-black"
          } text-3xl justify-items-center  pt-[10px] w-[40px] h-[40px] rounded-[50%]  cursor-pointer  `}
        >
