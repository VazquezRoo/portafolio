...
function Home({}) {
  ...
  return (
    ...
    <div id='home' className=' self-center grid w-[80%] w-max-[600px]  pt-[60px] text-[25px] tracking-[4px] min-[600px]:mt-[100px] min-[600px]:text-[40px] min-[800px]:text-[50px]'>
     ...
     <div id='about_home' className='grid  mt-[40px] w-full max-w-[1200px] border-t-[1px] border-white/40 pt-[50px]  px-6'>
    ...
    <div id='skills_home' className='grid w-[90%] justify-items-center mt-[100px]  border-t-[1px] border-white/10 '>
        <Skills/>
      </div>
